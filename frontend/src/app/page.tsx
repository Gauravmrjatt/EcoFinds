...
export default function Home() {
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-green-50 to-white py-12 sm:py-16 lg:py-20 min-h-[80vh]">
            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <div className="flex flex-col gap-4 justify-center lg:justify-start">
                  ...
                  <Button variant="outline" size="lg" className="w-full bg-green-600 text-white">
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Verified Eco-Friendly</h3>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Direct from Sellers</h3>
                    <p className="mt-5 text-base text-gray-500">
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Impact Tracking</h3>
                    <p className="mt-5 text-base text-gray-500">
      ...
      <section className="bg-green-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-green-200">Start your sustainable journey today.</span>
          </h2>
