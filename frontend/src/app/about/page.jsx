    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl mb-6">
          About <span className="text-green-600">EcoFinds</span>
        </h1>
      ...
      <div className="mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-gray-900">Alex Green</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-gray-900">Sam Rivers</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium text-gray-900">Jamie Taylor</h3>
